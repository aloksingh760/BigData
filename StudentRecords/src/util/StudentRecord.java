...
public class StudentRecord implements WritableComparable<StudentRecord> {
	...
	public int hashCode() {
		...
		return roll.hashCode() + schoolName.hashCode() + studentName.hashCode()
				...
				+ subject.hashCode() + marks.hashCode() + averageMarks.hashCode();
	...
	public boolean equals(Object o) {
		...
		if (o instanceof StudentRecord) {
			...
			return roll.equals(sr.roll) && schoolName.equals(sr.schoolName)
					...
					&& subject.equals(sr.subject) && marks.equals(sr.marks) && averageMarks.equals(sr.averageMarks);
		}
		return false;
	...
	public String toString() {
		...
		return roll + "," + schoolName + "," + studentName + "," + age
				+ "," + gender + "," + clss + "," + subject + "," + marks +","+ averageMarks;
	...
	public int compareTo(StudentRecord sr) {
		...
		cmp= marks.compareTo(sr.marks);
		if(cmp !=0){
		return cmp;
		}
        return averageMarks.compareTo(sr.averageMarks);
	}
	...
	public FloatWritable getAverageMarks() {
		return averageMarks;
	}

	public void setAverageMarks(FloatWritable averageMarks) {
		this.averageMarks = averageMarks;
	}
